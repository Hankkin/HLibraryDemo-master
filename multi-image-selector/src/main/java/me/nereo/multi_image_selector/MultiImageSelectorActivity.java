...
public class MultiImageSelectorActivity extends FragmentActivity implements MultiImageSelectorFragment.Callback{
    ...
    /**已经选择的数量*/
    public static final String EXTRA_HAS_SELECT_NUM = "has_seelct_num";
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(resultList != null && resultList.size() >0){
                    ...
                    bundle1.putSerializable(EXTRA_RESULT,resultList);
    ...
    public void onSingleImageSelected(String path) {
        Intent data = new Intent();
        Image image = new Image(path,null,0,null);
    ...
    public void onCameraShot(File imageFile) {
        if(imageFile != null) {
            ...
            Intent data = new Intent();
            Image image = new Image(imageFile.getAbsolutePath(),null,0,null);
            resultList.add(image);
            Bundle bundle = new Bundle();
            bundle.putSerializable(EXTRA_RESULT,resultList);
            data.putExtras(bundle);
